...
class ConfigDownloadFrame(QObject):
    ...
    def updateLikeShowTable(self):
        index = self.downloadFrame.singsTable.currentRow()
        print(index)
        # for i in range(3):
        #     self.showTable.setItem(rowCount, i, QTableWidgetItem(showInfo[i]))
    ...
    def fromPathLoadSong(self, selectFolder):
        ...
        print(self.downloadFrame.singsTable)
