...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('resource/2.ico'))
    ...
    def addAllPlaylist(self):
        ...
        self.mainContent.addTab(self.indexQQSings, "小鱼歌单")
...
class Header(QFrame):
    ...
    def setLabels(self):
        """创建所需的所有标签。"""
        self.logoLabel = PicLabel(r'resource/q.png', 32, 32)

        self.descriptionLabel = QLabel(self)
        self.descriptionLabel.setText("<b>小鱼音乐</b>")

        self.userPix = PicLabel(r'resource/q.png', 32, 32, r'resource/user_pic_mask.png')
...
class Navigation(QScrollArea):
    ...
    def setListViews(self):
        ...
        self.navigationList.addItem(QListWidgetItem(QIcon('resource/1.png'), " "))
        self.navigationList.addItem(QListWidgetItem(QIcon('resource/1.png'), "  "))
        ...
        self.nativeList.addItem(QListWidgetItem(QIcon('resource/notes.png'), "收藏"))

        self.nativeList.addItem(QListWidgetItem(QIcon('resource/download_icon.png'), " 本地下载"))
        self.nativeList.addItem(QListWidgetItem(QIcon('resource/recommend_icon.png'), " 猜你喜欢"))
    def setLayouts(self):
        """定义布局。"""
